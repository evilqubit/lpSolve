		...
		<div class="row">
			<div class="col-md-4">
				<form id="hidden_form" method="POST" action="">
					<input type="hidden" name="save_teachers" value="1">
					<br>
					<a href="teachers"><div class="btn btn-primary">Back to all Teachers</div></a>
					<br><br>
					<div class="form-group">
						<label>Name</label>
						<input class="form-control" name="name" type="text" value="">
					</div>
					<button class="btn btn-success" type="submit" id="save_settings">Add Teacher</button>
				</form>
